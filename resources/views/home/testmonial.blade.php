<div class="bg-granada-blue-light h-fit">
    <div class="container  mx-auto py-20 md:px-6 font-JF">
        <section class="mb-32 text-center">
            <div class="text-center py-4">
                <p class="text-gray-400 font-semibold">الأراء</p>
                <h2 class="text-gray-800 text-2xl font-semibold mt-2 ">أراء عملاؤنا</h2>
            </div>
            <div class="grid gap-x-6 md:grid-cols-3 pt-8 px-4 lg:gap-x-12">
