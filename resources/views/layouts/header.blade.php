      ...
      <nav class="w-11/12 bg-granada-betrolum border-gray-200 flex items-center justify-between mx-auto p-4">
        ...
        <div class="hidden w-full md:flex  md:w-auto " id="navbar-default">
            <ul class="flex flex-col p-4 md:p-0 mt-4 border text-white font-semibold md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-granada-betrolum  ">
              ...
              <li>
                <a href="{{ route('page.show',['name'=>'about-us']) }}" class="block py-2 px-3  rounded  md:hover:bg-transparent md:border-0 hover:text-granada-betrolum-light hover:font-bold md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">من نحن</a>
              </li>
              <li>
                <a href="{{ route('page.show',['name'=>'services']) }}" class="block py-2 px-3  rounded  md:hover:bg-transparent md:border-0 hover:text-granada-betrolum-light hover:font-bold md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">خدماتنا</a>
              </li>
              <li>
                <a href="{{ route('page.show',['name'=>'blog']) }}" class="block py-2 px-3 rounded  md:hover:bg-transparent md:border-0 hover:text-granada-betrolum-light hover:font-bold md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">المدونة</a>
              </li>
            </ul>
        </div>
      </div>
